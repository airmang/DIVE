...
// Labels are i18n keys (resolved with `t()` at the render site, never persisted);
// see agency_status.* in src/i18n/{en,ko}.json.
export const AGENCY_STATE_META: Record<AgencyStateId, Omit<AgencyStateItem, "id">> = {
  intent_needed: {
    component: "intent",
    labelKey: "agency_status.intent_needed",
    tone: "warn",
  ...
  plan_review_needed: {
    component: "plan",
    labelKey: "agency_status.plan_review_needed",
    tone: "warn",
    evidenceBacked: false,
    priority: 50,
  },
  approval_required: {
    component: "action",
    labelKey: "agency_status.approval_required",
    tone: "warn",
    evidenceBacked: false,
    priority: 75,
  },
  running: {
    component: "action",
    labelKey: "agency_status.running",
    tone: "info",
    evidenceBacked: false,
    priority: 30,
  },
  diff_review_needed: {
    component: "diff",
    labelKey: "agency_status.diff_review_needed",
    tone: "warn",
    evidenceBacked: false,
    priority: 65,
  },
  verification_needed: {
    component: "verify",
    labelKey: "agency_status.verification_needed",
    tone: "warn",
    evidenceBacked: false,
    priority: 60,
  },
  verified_with_evidence: {
    component: "verify",
    labelKey: "agency_status.verified_with_evidence",
    tone: "success",
    evidenceBacked: true,
    priority: 10,
  },
  ai_self_report_only: {
    component: "verify",
    labelKey: "agency_status.ai_self_report_only",
    tone: "risk",
    evidenceBacked: false,
    priority: 90,
  },
  verification_failed: {
    component: "verify",
    labelKey: "agency_status.verification_failed",
    tone: "risk",
    evidenceBacked: false,
    priority: 100,
  },
  verification_deferred: {
    component: "decision",
    labelKey: "agency_status.verification_deferred",
    tone: "info",
    evidenceBacked: false,
    priority: 55,
  },
  rollback_available: {
    component: "rollback",
    labelKey: "agency_status.rollback_available",
    tone: "info",
    evidenceBacked: true,
    priority: 20,
  },
  approved_with_risk: {
    component: "decision",
    labelKey: "agency_status.approved_with_risk",
    tone: "risk",
    evidenceBacked: false,
    priority: 95,
  },
