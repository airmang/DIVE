  ...
  return (
    ...
    >
      <div className="flex items-start gap-2 border-b border-warn/30 bg-warn/10 px-3 py-2">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 text-sm">
            <span className="font-medium text-fg">{t("permission_card.warn.title")}</span>
            <McpProvenanceBadge name={card.toolName} />
          </div>
          <p className="text-xs text-fg-muted">{t("permission_card.warn.description")}</p>
        </div>
      </div>
      ...
      {approvalRequirement?.required ? (
        <div
          className="space-y-2 border-t bg-warn/10 px-3 py-2 text-xs text-fg"
        ...
        >
          ...
          {approvalRequirement.onConfirmChange ? (
            <label
              className="flex items-start gap-2 rounded-sm border border-warn/30 bg-bg/70 px-2 py-2"
      ...
      <footer className="flex flex-wrap items-center justify-between gap-2 border-t bg-bg-panel2/30 px-3 py-2">
        ...
        <div className="flex flex-wrap gap-1">
          ...
          >
            <Check />
            {t("permission_card.warn.approve")}
          </Button>
        </div>
      </footer>
    </div>
