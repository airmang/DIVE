    ...
    if locale.to_ascii_lowercase().starts_with("en") {
        format!(
            "You are DIVE's Socratic planning interviewer. When the user describes what they want \
             ...
             - If the user answers vaguely, ask again for specific criteria, audience, scope, or constraints.\n\
             - Do not output completion markers or control tokens, and do not create the final JSON on your own.\n\
             - Once the goal, scope, key constraints, and acceptance criteria are concrete enough, usually within 3-6 exchanges, summarize what you learned in 2-3 lines and ask: \"Should I make the plan this way? Tell me what to refine if anything is missing.\"\n\
        ...
        format!(
            "당신은 DIVE의 소크라테스식 계획 인터뷰어입니다. 사용자가 만들고 싶은 것을 설명하면 \
             ...
             - 목표·범위·핵심 제약·수용기준이 어느 정도 구체화되면(보통 3~6번의 교환 안에서) 같은 질문을 반복하지 말고, 파악한 내용을 2~3줄로 요약한 뒤 \"이대로 계획을 만들까요? 더 다듬을 부분이 있으면 알려주세요\"라고 진행 여부를 물어보세요.\n\
