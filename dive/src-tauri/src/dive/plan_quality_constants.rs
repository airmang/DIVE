...
// S-050: observable-marker and filler vocabulary for the plan
// criterion-quality lint. Consolidated here (Wily S-066) from the former
// `workspace_plan.rs` quality gate so every quality-lint keyword list shares
// one home alongside the marker families above.
pub const VAGUE_FILLER_WORDS: &[&str] = &[
    "make", "it", "just", "do", "be", "is", "are", "the", "a", "an", "to", "for", "with", "and",
    "or", "in", "you", "decide", "best", "well", "way", "ways",
];

pub const NUMERIC_CONTEXT_MARKERS: &[&str] = &[
    "px",
    "pixel",
    "pixels",
    "percent",
...
pub const COMPARATOR_MARKERS: &[&str] = &[
    ">",
    "<",
    "=",
    ">=",
...
pub const NAMED_UI_MARKERS: &[&str] = &[
    "button",
    "input",
    "field",
    "form",
