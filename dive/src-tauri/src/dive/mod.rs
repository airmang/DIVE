...
pub use supervisor::{
    ...
    record_ai_claimed_done_evidence, supervisor_provoke_gate, validate_supervisor_decision,
    ...
    ProvocationSeverity, ScopeExpansionEvidenceRefInput, ScopeExpansionSupervisorContextBuildInput,
    SourceUiMode, SupervisorActionId, SupervisorContext, SupervisorContextBuildInput,
    SupervisorContextBuildResult, SupervisorDecision, SupervisorDecisionSummary,
    SupervisorDedupKey, SupervisorDedupState, SupervisorDropReason, SupervisorEvaluationLog,
    SupervisorEvent, SupervisorMode, SupervisorValidationOutcome, SupervisorValidationResult,
