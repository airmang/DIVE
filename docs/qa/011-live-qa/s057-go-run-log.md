...
- 회차 1 — 3개 Step 완료 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
- 회차 1 — 90초 관찰 후 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
...
- 회차 2 — 3개 Step 완료 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
- 회차 2 — 90초 관찰 후 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
...
- 회차 3 — 3개 Step 완료 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
- 회차 3 — 90초 관찰 후 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
...
회차 1 PRD 구조화 실패 (내부 연구 노트/스크린샷, 공개 저장소 미포함)
